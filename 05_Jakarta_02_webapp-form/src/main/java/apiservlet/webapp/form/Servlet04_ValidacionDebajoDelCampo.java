 ...
 *  que ahora es un jsp
 * Los errores se van a mostrar debajo del campo
 */
...
@WebServlet(name = "Servlet04_ValidacionDebajoDelCampo", urlPatterns = {"/validacionDebajoDelCampo"})
public class Servlet04_ValidacionDebajoDelCampo extends HttpServlet 
{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException
    {
        ...
        if (errores.isEmpty())
        {
            try (PrintWriter out = res.getWriter()) 
            {
                ...
                out.println("<html>");
                out.println("   <head>");
                out.println("   <title>Errores en el mismo form (Servlet_04)</title>");
                out.println("</head>");
                out.println("<body>");
                ...
                out.print("<div>");
                out.println("   <p><a href=\"/05_Jakarta_02_webapp-form/04_ValidacionDebajoDelCampo.jsp\">Regresar al formulario (04_ValidacionDebajoDelCampo.jsp)</a></p> ");
        ...
        else // si hay errores 
        {
            ...
            getServletContext().getRequestDispatcher("/04_ValidacionDebajoDelCampo.jsp").forward(req, res);
        }
    }
}
