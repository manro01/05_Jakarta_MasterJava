...
@WebServlet(name = "Servlet06_ValoresGuardados", urlPatterns = {"/valoresGuardados"})
public class Servlet06_ValoresGuardados extends HttpServlet 
{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException
    {
        ...
        if (errores.isEmpty())
        {
            try (PrintWriter out = res.getWriter()) 
            {
                ...
                out.println("<html>");
                out.println("   <head>");
                out.println("   <title>Errores en el mismo form (Servlet_06)</title>");
                out.println("</head>");
                out.println("<body>");
                ...
                out.print("<div>");
                out.println("   <p><a href=\"/05_Jakarta_02_webapp-form/06_GuardandoValoresForm.jsp\">Regresar al formulario (06_GuardandoValoresForm)</a></p> ");
        ...
        else // si hay errores 
        {
            ...
            getServletContext().getRequestDispatcher("/06_GuardandoValoresForm.jsp").forward(req, res);
        }
    }
}
